...
export const ja: Record<string, string> = {
  ...
  // ArtboardFrame
  'Create a primary banner': 'メインバナーを作成し、',
  'and adapt to different sizes.': 'さまざまなサイズに合わせて調整しましょう。',
  'or drag images from your computer': 'または、コンピューターから画像をドラッグ',
  'Selection area': '選択範囲',
  'Confirm focus area': 'フォーカス範囲を確定',
  'Move or resize to set the focus area': 'ドラッグまたはリサイズしてフォーカス範囲を設定',
  'New Banner': '新しいバナー',
  ...
  'Group layers': 'レイヤーをグループ化',
  'Copy group': 'グループをコピー',
  'Duplicate group': 'グループを複製',
  'Lock group': 'グループをロック',
  'Unlock group': 'グループのロックを解除',
  'Ungroup': 'グループ解除',
